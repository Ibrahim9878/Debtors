...
/*var debtors1 = debtors.Where(d => d.Email.EndsWith("rhyta.com"))
//                     .Where(d => d.Email.EndsWith("dayrep.com"));

//debtors1 = debtors1.ToList();
...
//var debtors2 = debtors.Where(d =>
//{
//    int age = Math.Abs(d.BirthDay.Year - DateTime.Now.Year);
//    return age > 26 && age < 36;
//}).ToList();
//debtors2.ForEach(d => Console.WriteLine(d));

#endregion
#region task 4
//4) Borcu 5000-den cox olmayan borclularic cixartmag
//var debtors3 = debtors.Where(d => d.Debt > 500).ToList();
//debtors3.ForEach(d => Console.WriteLine(d));
#endregion
#region task 5
//5) Butov adi 18 simvoldan cox olan ve telefon nomresinde 2 ve ya 2-den cox 7 reqemi olan borclulari cixartmaq
//var debtors4 = debtors.Where(d => d.FullName.Length >= 18).Where(d => d.Phone.Count(c => c == '7') > 1).ToList();

//debtors4.ForEach(d => Console.WriteLine(d));
#endregion
#region task 7
//7) Qishda anadan olan borclulari cixardmaq 
//var debtors5 = debtors.Where(d => d.BirthDay.Month == 1 || d.BirthDay.Month == 12 || d.BirthDay.Month == 11).ToList();
...
//var debtors7 = debtors.Where(d => d.Phone.Count(c => c == '8') == 0).ToList();
//debtors7.ForEach(d =>
//{
//    Console.Write(d.FullName);
//    Console.Write(" / ");
//    Console.Write(Math.Abs(d.BirthDay.Year - DateTime.Now.Year));
//    Console.Write(" / ");
...
//    .Where(d => d.FullName.Distinct().Count(c => d.FullName.Count(ch => ch == c) >= 3) > 0)
